...
export function GoogleSignInButton({
	...
	return (
		<button
			...
			onClick={onClick}
			className={cn(
				'group relative flex w-full h-12 items-center justify-center gap-3 rounded-md',
				'bg-white text-[#3c4043] font-semibold text-[15px] tracking-[-0.01em]',
				'shadow-[0_1px_2px_rgba(0,0,0,0.35),0_0_0_1px_rgba(255,255,255,0.08)]',
		...
		>
			<span className="flex size-8 items-center justify-center rounded-full bg-white shadow-[inset_0_0_0_1px_rgba(60,64,67,0.12)] group-hover:shadow-[inset_0_0_0_1px_rgba(60,64,67,0.18)]">
				{loading ? (
					<span className="size-4 rounded-full border-2 border-zinc-300 border-t-[#4285F4] animate-spin" />
				) : (
					<GoogleMark />
				)}
			</span>
